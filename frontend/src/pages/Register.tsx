...
export default function Register() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', role: 'farmer' as Role, phone: '', county: 'Juba' });
    ...
    <div className="flex min-h-screen items-center justify-center bg-mist px-6 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-card">
          ...
          <p className="mt-1 text-sm text-slate-500">Join the platform as a farmer or buyer</p>
